...
Sequently, various [Prompt-to-Prompt](https://arxiv.org/abs/2208.01626) text-based editing operations are applied. Prompt-to-prompt provides users with simple and intuitive means to edit images leveraging textual semantic power and preserving the original composition and structure.
